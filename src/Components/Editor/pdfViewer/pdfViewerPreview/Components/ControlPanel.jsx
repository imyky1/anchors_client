...
const ControlPanel = (props) => {
  ...
  const isLastPage = pageNumber === Number(previewPages);
  console.log(isLastPage, pageNumber, previewPages);
  ...
  const goToLastPage = () => {
    if (!isLastPage) setPageNumber(Number(previewPages));
  };
