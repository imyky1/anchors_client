        ...
        <section className="just_background_color_creator_profile">
          ...
          <section className="creator_details_section">
            ...
            <div className="creator_main_details_parts_02">
              <div>
              {basicCreatorInfo?.teleLink && <FaTelegramPlane onClick={()=>{window.open(basicCreatorInfo?.teleLink)}}/>}
                {basicCreatorInfo?.linkedInLink && <FaLinkedinIn onClick={()=>{window.open(basicCreatorInfo?.linkedInLink)}}/>}
                {basicCreatorInfo?.instaLink && <AiFillInstagram onClick={()=>{window.open(basicCreatorInfo?.instaLink)}}/>}
                {basicCreatorInfo?.ytLink && <AiFillYoutube onClick={()=>{window.open(basicCreatorInfo?.ytLink)}}/>}
                {basicCreatorInfo?.twitterLink && <AiOutlineTwitter onClick={()=>{window.open(basicCreatorInfo?.twitterLink)}}/>}
              </div>
              {window.screen.width > 550 && (
                <button className="request_resource_button_creator_profile">
                  Request Resources
              ...
              .map((e2, index) => {
                return (
                  ...
                  >
                    ...
                    {e2?.desc.length > 100 ? e2?.desc?.slice(0,100) + "..." : e2?.desc}
                    </p>
                  </div>
                );
              })}
