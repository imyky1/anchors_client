        ...
        <div className="edit_profile_outside_wrapper_left">
          {!leftData && (
            <div className="personalinfo_wrap">
              <div className="personalinfo_top">
                ...
                {/* <button
              className="edit_profile_sample_page_button"
              onClick={() => {
                mixpanel.track("Preview Sample Profile");
                window.open("https://www.anchors.in/arohi-agrawal");
              }}
            >
              ...
              <div className="personalinfo_savebutton">
                <button onClick={onNext}>
                  Save & Next <BsArrowRight style={{ paddingLeft: "5px" }} />{" "}
                </button>
              </div>
              {/* <div className="personalinfo_savebutton">
          ...
          {leftData && (
            <div className="personalinfo_socialwrap_01">
              ...
              >
                <button onClick={onNext}>
                  <BsArrowLeft style={{ paddingRight: "5px" }} />
                  Previous
                </button>
                <button onClick={onSubmit}>
                  Save <BsArrowRight style={{ paddingLeft: "5px" }} />{" "}
                </button>
              </div>
            </div>
          )}
