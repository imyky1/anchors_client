    ...
    <div className="sidebar_main_box">
        ...
        <div>
            ...
            <section className="creator_sidebar_details">
                <img src="https://media.npr.org/assets/img/2022/11/08/ap22312071681283-0d9c328f69a7c7f15320e8750d6ea447532dff66.jpg" alt="" />
                <div>
                    <p className="text_sidebar_01">
                    Himanshu Kumar  
                    </p>
                    <div className="text_sidebar_02"><span><i class="fa-solid fa-star"></i> 4.5</span><span className='reviews_from_sidebar'>99 Reviews</span></div>
                </div>
            </section>
            <span><img src={Globe} alt="" />&nbsp;&nbsp;Public Profile</span>
            </div>
            <section className="sidebar_navigation">
                <div><img src={svg1} alt="" />Dashboard</div>
                <div><img src={svg2} alt="" />My Content</div>
                <div><img src={svg3} alt="" />Payment</div>
                <div><img src={svg4} alt="" />Requests</div>
                <div><img src={svg5} alt="" />Statistics</div>
            </section>
        </div>
        ...
        <section className="invite_sidebar">
            ...
            <div>KA2104 <span><img src={svg6} alt="" /></span></div>
        </section>
    </div>
  )
}
