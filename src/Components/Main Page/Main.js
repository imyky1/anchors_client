      ...
      >
        ...
        <SwiperSlide><div className="creatordetails">
            ...
            <div className="main_creator">
              ...
              <div className="social_main">
                <a href="https://www.linkedin.com/in/himanshushekhar16/" target="_black" rel="no_referrer" style={{color:"black"}}><i className="fa-brands fa-linkedin fa-xl"></i></a>
                <a href="https://www.instagram.com/himanshushekhar_official/" target="_black" rel="no_referrer" style={{color:"black"}}><i className="fa-brands fa-instagram fa-xl "></i></a>
                <a href="https://mobile.twitter.com/hszone07" target="_black" rel="no_referrer" style={{color:"black"}}><i className="fa-brands fa-twitter fa-xl "></i></a>
              </div>
              <button onClick={()=>{ mixpanel.track("Clicked Featured creators on Anchors Main Page",{creator:"Himanshu Shekhar"})
              window.open("/c/himanshu-shekhar","_blank")}}>View Anchor Profile</button>
            </div>
          </div></SwiperSlide>
      </Swiper>
        </section>
        ...
        <section className="checkeligibility" id="eligibility">
          <h1>
            Stand out and get a chance to be an
            anchor
          </h1>
          ...
          <div className="input_eligibility">
            ...
            <input type="number" placeholder="Number of Followers" value={followers} onChange={(e)=>{setFollowers(e.target.value)}}/>
        ...
        <div className="mainheaders1">
            <h2>Wall of love</h2>
            <span>
            Love from audience to their anchor 
            </span>
          </div>
          <div className="feedbacks_mainpage">
            { data ? data?.filter((e1)=>{return e1?.userID?.name}).map((e,i)=>{
              return (<div>
              <p>{e?.desc}</p>
              <div className="user_details_fb_main">
                <img src={e?.userID?.photo} alt="" />
                <span>{e?.userID?.name ? e?.userID?.name : "unknown"}</span>
              </div>
            </div>
            )}) : ""}
            </div>
        ...
        <section className="mainpage_footer">
          <ul className="footer_articles">
            <a href="https://www.linkedin.com/company/beanchorite/" target="_black" rel="no_referrer"><li>LinkedIn</li></a>
            ...
            <a href="/login/creators"><li>Become a creator</li></a>
          </ul>
        </section>
      </div>
    </div>
