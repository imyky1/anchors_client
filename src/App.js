...
const ExcelViewer = lazy(() =>
  import("./Components/Editor/excelviewer/ExcelViewer")
);
...
const PredictorData = lazy(() =>
  import("./Components/Earning Potential/PredictorData")
);
...
const TermsAndConditions = lazy(() =>
  import("./Components/Static pages/Terms")
);
const Success = lazy(() =>
  import("./Components/Editor/New UI/Event Success Page/Success")
);
...
const UserDashboard2 = lazy(() =>
  import("./Components/User Dashboard2/UserDashboard")
);
...
function App() {
  ...
  useEffect(() => {
    if (verifiedData?.userType === "user") {
      if(!verifiedData?.data?.phoneNumber || verifiedData?.data?.phoneNumber === ""){
        setHandleUserLoginForm(true)
      }
    }
  }, [verifiedData]);
                      ...
                      <Suspense fallback={<LoadThree />}>
                        <Routes>
                            ...
                            element={
                              <ProtectedRoute
                                notAllowCondition={
                                  ...
                                  (verifiedData &&
                                    verifiedData?.userType !== "creator")
                                }
                                navigateTo="/"
                              >
                                {" "}
                                <HomeUI progress={changeprogress} />
                              </ProtectedRoute>
                            }
                          ></Route>
                          <Route
                          ...
                          <Route
                            exact
                            path="/:slug"
                            element={<ProfilePage progress={changeprogress} />}
                          ></Route>
                          <Route
                            exact
                            path="/s/:slug"
                          ...
                          <Route
                            path="/checkpayment/:type/:slug"
                            element={<CheckPayment progress={changeprogress} />}
                          ></Route>
                          ...
                          ></Route>
                          {/* Demo Page */}
                          <Route path="/hostevent" element={<Sample />}></Route>
                          {/* Redirection routes ---------------------------------------------------------------------- */}
                          <Route
                            path="/r/:id"
